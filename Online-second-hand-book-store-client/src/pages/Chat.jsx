...
export default function Chat() {
  ...
  return (
    <div className="container d-flex flex-column" onLoad={scroll}>
      {/* <div className="pos-fixed-container"> */}
      <div
        className="container p-3 bg-white rounded overflow-auto"
        id="chat-body"
        style={{ height: "35em", marginTop: "2em", width: "40em" }}
      >
    ...
    <button type="button" class="btn btn-primary mb-2">Send</button>
      ...
      <div class="card-footer text-muted d-flex justify-content-start align-items-center p-3 text-input mx-auto">
        <input
          type="text"
